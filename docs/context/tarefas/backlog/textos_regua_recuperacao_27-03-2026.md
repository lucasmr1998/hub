...
Escrever os textos de todas as mensagens da régua de recuperação pós-trial seguindo a estrutura definida em:
`exports/drafts/email/regua_recuperacao_pos_trial_estrutura.md`

## Atividades

### Segmento: Usou o trial
...
PMM redige todos os textos. Scripts do parceiro (D+22 e D+30) salvos em exports/drafts/scripts_vendas/. Demais mensagens em exports/drafts/whatsapp/ e exports/drafts/email/.

## Dependências

- Estrutura aprovada: exports/drafts/reguas/regua_recuperacao_pos_trial_estrutura.md ✅

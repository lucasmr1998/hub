...
from . import new_service_api
from . import views_upgrade_conversa
from . import views_notificacoes_v2
from .funil_insights import dashboard_funil_insights

app_name = 'vendas_web'

urlpatterns = [
    # ── Notificações v2 (central) + Central de Ajuda ──
    path('notificacoes/', views_notificacoes_v2.central_notificacoes, name='notificacoes_central'),
    path('api/v2/notificacoes/', views_notificacoes_v2.api_notif_listar_v2, name='api_notif_listar_v2'),
    path('api/v2/notificacoes/<int:notificacao_id>/lida/', views_notificacoes_v2.api_notif_marcar_lida, name='api_notif_marcar_lida'),
    path('api/v2/notificacoes/marcar-todas/', views_notificacoes_v2.api_notif_marcar_todas, name='api_notif_marcar_todas'),
    path('ajuda/', views_notificacoes_v2.ajuda_home, name='ajuda'),
    path('ajuda/<str:perfil>/', views_notificacoes_v2.ajuda_guia, name='ajuda_guia'),
    ...
    path('novo-dashboard/', views.dashboard_unificado, name='dashboard_unificado'),  # Nova rota para o template
    ...
    # 'ajuda' (Central de Ajuda / Manual do Usuário) é registrada acima, via
    # views_notificacoes_v2.ajuda_home + ajuda_guia (guias por perfil RBAC).
    ...
    path('api/cadastro/validar-imagem-ia/', views.api_validar_imagem_ia,
         name='api_validar_imagem_ia'),

    # Acompanhamento pos-cadastro e agendamento de instalacao
    path('acompanhamento/<int:cadastro_id>/', views.acompanhamento_cadastro, name='acompanhamento_cadastro'),
    path('api/acompanhamento/<int:cadastro_id>/status/', views.api_acompanhamento_status, name='api_acompanhamento_status'),
    path('api/instalacao/datas/', views.api_consultar_datas_instalacao, name='api_consultar_datas_instalacao'),
    path('api/instalacao/agenda/', views.api_consultar_agenda_instalacao, name='api_consultar_agenda_instalacao'),
    path('api/instalacao/agendar/', views.api_agendar_instalacao, name='api_agendar_instalacao'),
    ...
    # APIs CRM — Status e Tags (N8N)
    path('api/leads/status/', views.api_lead_atualizar_status, name='api_lead_atualizar_status'),
    ...
    # NewService — contratação de novo serviço por cliente Hubsoft existente
    path('api/new-service/criar/',              new_service_api.criar_new_service_api,              name='criar_new_service'),
    path('api/new-service/atualizar/',          new_service_api.atualizar_new_service_api,          name='atualizar_new_service'),
    path('api/new-service/obter/',              new_service_api.obter_new_service_api,              name='obter_new_service'),
    path('api/new-service/imagens/registrar/',  new_service_api.registrar_imagem_new_service_api,   name='registrar_imagem_new_service'),
    path('api/new-service/finalizar/',          new_service_api.finalizar_new_service_api,          name='finalizar_new_service'),
    ...
    # Fluxo de UPGRADE conversacional (consumido pelo serviço ia_validacao)
    path('api/upgrade-conversa/turno/', views_upgrade_conversa.turno_upgrade_conversa, name='api_upgrade_conversa_turno'),

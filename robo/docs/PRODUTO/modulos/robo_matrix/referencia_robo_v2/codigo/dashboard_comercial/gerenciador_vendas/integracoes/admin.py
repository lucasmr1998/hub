...
# =========================================================================
# Atendimentos Hubsoft
# =========================================================================

@admin.register(AtendimentoHubsoft)
class AtendimentoHubsoftAdmin(admin.ModelAdmin):
    list_display = ["id_atendimento", "protocolo", "tipo_atendimento", "status", "cliente", "data_cadastro", "data_sync"]
    list_filter = ["status", "status_fechamento", "tipo_atendimento"]
    search_fields = ["protocolo", "id_atendimento", "cliente__nome_razaosocial", "cliente__cpf_cnpj"]
    readonly_fields = ["dados_completos", "data_sync", "data_criacao"]
    autocomplete_fields = ["cliente"]


# =========================================================================
# Ordens de Serviço Hubsoft
# =========================================================================

@admin.register(OrdemServicoHubsoft)
class OrdemServicoHubsoftAdmin(admin.ModelAdmin):
    list_display = ["numero_ordem_servico", "tipo", "status", "cliente", "data_cadastro", "data_sync"]
    list_filter = ["status", "status_fechamento", "tipo"]
    search_fields = ["numero_ordem_servico", "id_ordem_servico", "cliente__nome_razaosocial", "cliente__cpf_cnpj"]
    readonly_fields = ["dados_completos", "tecnicos", "data_sync", "data_criacao"]
    autocomplete_fields = ["cliente", "atendimento"]

...
class ConversaOutputSerializer(serializers.Serializer):
    ...
    ultima_mensagem_em = serializers.DateTimeField(format='iso-8601')
    ...
    data_abertura = serializers.DateTimeField(format='iso-8601')
...
class MensagemOutputSerializer(serializers.Serializer):
    ...
    data_leitura = serializers.DateTimeField(format='iso-8601')
